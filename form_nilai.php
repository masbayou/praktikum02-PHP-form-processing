...
<form method="POST" action="nilai_siswa.php">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="name" name="nama" placeholder="Masukan Nama Lengkap Anda" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <div class="offset-4 col-8">
      <button name="proses" type="submit" value="Data Telah di simpan" class="btn btn-primary">Submit</button>
    </div>
  </div>
  </div>
</form>
